...
if "auto_gps_on_load" not in st.session_state:
    st.session_state.auto_gps_on_load = True
...
st.info(
    "Al abrir HOMOLOGADOR desde celular o computador se puede solicitar permiso para usar la ubicación del dispositivo. "
    "El navegador siempre pedirá autorización antes de compartir el GPS. En celular suele ser más preciso."
)
