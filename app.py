...
if st.session_state.comuna_selector not in comunas_ordenadas:
    st.session_state.comuna_selector = st.session_state.comuna_actual
...
st.caption(
    ...
    "Ejemplo: -33.4175459, -70.5727107. "
    "También funciona si pegas un enlace largo de Google Maps que contenga las coordenadas."
)
...
if st.button("Usar coordenadas de Google Maps"):
    ...
    if lat_google is None or lon_google is None:
        ...
        if comuna_google and comuna_google in indice:
            ...
            st.session_state.comuna_selector = comuna_google
            st.success(
...
if st.button("Homologar coordenadas"):
    ...
    if comuna_manual and comuna_manual in indice:
        ...
        st.session_state.comuna_selector = comuna_manual
